...
You will need the [Stack Tool](https://docs.haskellstack.org/en/stable/README/) for Haskell to compile Aura yourself. Then:
...
Performs a sweep of all PKGBUILDs on the [AUR](https://aur.archlinux.org/), looking for Bash misuse.
