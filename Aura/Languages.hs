...
checkDBLock_1 French    = "Le base de données des paquets est bloquées. Appuyez sur entrer pour continuer."
...
getAURPkgInfo_1 French    = "La recherche dans l'API AUR a échoué. Verifiez votre connexion."
...
absSync_1 French    = "Synchronizer l'arbre ABS local?"
...
absSync_2 French    = "Sychronization de l'arbre ABS local..."
...
singleSync_1 p French    = "Synchronization de " ++ bt p ++ " dans l'arbre ABS local..."
...
absInfoFields French    = [ "Dépôt","Nom","Version","Dépendences","Dépendences de compilation","Description" ]
...
saveState_1 French    = "État des paquets sauvegardés."
...
restoreState_1 French    = "Requête de rétrogradation de version non disponible pour:"
