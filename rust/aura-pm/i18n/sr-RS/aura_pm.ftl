language-name = Cрпски

# AUR Packages (-A)
A-install-deps = Утврђивање зависности...
A-install-repo-pkgs = Зависности из ризница:
...
A-build-fail = Изградња пакета није успела.
...
A-i-repo = Ризница
A-i-version = Верзија
A-i-status = Статус у AUR-у
# A-i-maintainer = Maintainer
A-i-proj-url = Страница пројекта
A-i-aur-url = Страница у AUR-у
A-i-license = Лиценца
# A-i-group = Groups
...
A-u-fetch-info = Преузимање информација о пакетима...
A-u-comparing = Упоређивање верзија пакета...
A-u-no-upgrades = Ажурирање пакета из AUR-а није потребно.
A-u-to-upgrade = Пакети из AUR-а за надоградњу:
...
C-b-target = Бекапујем кеш у { $target }
...
C-c-keep = { $pkgs } верзије сваког од пакета ће бити сачуване. Остатак ће бити избрисан.
# C-c-freed = { $bytes } freed.

C-downgrade-which = Коју верзију { $pkg }-а желите?
...
# Logs (-L)
L-first = Прва инсталација
L-upgrades = Ажурирања
L-recent = Недавне радње
